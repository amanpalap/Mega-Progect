...
function About() {
  return (
    <div className="h-fit w-full">
      <div className="w-full md:mt-20 flex flex-wrap justify-center items-center">
        <div className="flex w-full justify-center items-center flex-wrap">
          <div className="rounded-xl backdrop-blur-2xl w-full text-center md:mx-80 p-2 mb-2">
            <h1 className="text-white w-full text-2xl font-extrabold">
              About This Website
            </h1>
          </div>
          <div className="rounded-xl backdrop-blur-2xl px-10 py-4 text-white text-center md:mx-80">
            <p>
